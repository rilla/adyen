...
module Adyen
  ...
  module Form
    ...
    def payment_parameters(parameters = {}, shared_secret = nil)
      ...
      raise ArgumentError, "Cannot generate form: :currency code attribute not found!"         unless parameters[:currency_code]  || parameters[:recurring_contract].include?('RECURRING')
      raise ArgumentError, "Cannot generate form: :payment_amount code attribute not found!"   unless parameters[:payment_amount] || parameters[:recurring_contract].include?('RECURRING')
